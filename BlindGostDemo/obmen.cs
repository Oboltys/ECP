...
{
    public partial class obmen : Form
    {
        public obmen()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int p = 20; //Convert.ToInt32(numP.Value);
            int g = 25; ///Convert.ToInt32(numG.Value);
            int x = 27; //Convert.ToInt32(numX.Value);
            crypt(p, g, x, strIn);
            decrypt(p, x, strOut);
        }
        ...
        private void obmen_Load(object sender, EventArgs e)
        {
